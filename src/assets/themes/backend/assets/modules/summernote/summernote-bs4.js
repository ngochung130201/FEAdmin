...
var Buttons = /** @class */ (function () {
        ...
        this.context.memo('button.style', function () {
            return _this.ui.buttonGroup([
                _this.button({
                    ...
                    contents: _this.ui.dropdownButtonContents((_this.ui.icon(_this.options.icons.magic) + ' <span class="note-current-style"/>'), _this.options),
    ...
    Buttons.prototype.updateCurrentStyle = function ($container) {
        ...
        if (styleInfo['ancestors']) {
            var length = styleInfo['ancestors'].length;
            var style_1 = styleInfo['ancestors'][length - 1].tagName.toLowerCase();
            var listData = [];
            $cont.find('.dropdown-style a').each(function (idx, item) {
                var $item = $$1(item);
                // always compare with string to avoid creating another func.
                var isChecked = ($item.data('value') + '') === (style_1 + '');
                $item.toggleClass('checked', isChecked);
                listData.push($item.data('value'));
            });
            if (listData.indexOf(style_1) >= 0) {
                var text = style_1.toUpperCase();
                switch (text){
                    case 'P': {
                        text = '';
                        break;
                ...
                $cont.find('.note-current-style').text(text);
            } else {
                $cont.find('.note-current-style').text('');
            }
        }
    };
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        fontSizes: ['8', '9', '10', '11', '12', '14', '15', '16', '17', '18' , '20', '22', '24', '26', '28', '30'],
